...
public class XedocIndividual {
	...
	public XedocIndividual(String nombreFichero){
	...
	public static void main(String args[]){
		XedocIndividual xedoc = new XedocIndividual("025_D_20150227_171616 $430 @118194 @HOSP @Ordes (médicas) r_f.pdf");
		xedoc.imprimeDatos();
	}
}
